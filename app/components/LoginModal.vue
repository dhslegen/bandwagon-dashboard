<template>
  ...
  >
    <div
      v-if="modelValue"
      class="fixed inset-0 z-[100] flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 p-4"
    >
      <!-- 背景装饰 -->
